...
def update(out, t, width, height, pred, real, fov = False, beacons = True):
    ...
    if fov:
        ...
        if (hdg < 0):
            hdg += 360
        cv2.ellipse(overlay, (int(pred[0]*multiplier)+5*offset, height-int(y*50)-offset), (2000, 2000), 360-hdg, 315, 360, (255, 255, 255), thickness=-1)
        cv2.ellipse(overlay, (int(pred[0]*multiplier)+5*offset, height-int(y*50)-offset), (2000, 2000), 360-hdg, 0, 45, (255, 255, 255), thickness=-1)
